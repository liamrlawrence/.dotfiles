...
vim.keymap.set("n", "<M-Tab>",          "<Cmd>silent! +tabmove<CR>",  { desc = "Move the current tab right" })
vim.keymap.set("n", "<M-S-Tab>",        "<Cmd>silent! -tabmove<CR>",  { desc = "Move the current tab left" })
